...
框架在设计上强调“状态管理优先”：先保证状态边界、状态迁移和状态一致性，再扩展功能与能力。

与传统的 AI 助手不同，Neo-MoFox 强调：
- 🧩 **状态管理优先** - 先治理状态，再扩展能力，避免系统割裂与漂移
...
### 🧩 状态管理优先
- 以状态为核心组织系统，而不是以功能堆叠组织系统
- 明确状态边界、迁移条件与上下文转移规则
- 保证同一身份在跨状态运行中的连续性与一致性
- 先稳定状态流，再扩展记忆、反思、主动行为等能力
